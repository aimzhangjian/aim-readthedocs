...
from .models import (Project, ImportedFile,
                     ProjectRelationship, EmailHook, WebHook, Domain, ProjectContentType)
...
class ProjectContentTypeAdmin(admin.ModelAdmin):
    list_display=('name',)
...
admin.site.register(ProjectContentType,ProjectContentTypeAdmin)
