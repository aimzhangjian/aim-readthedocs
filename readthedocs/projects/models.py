...
from readthedocs.projects import constants, utils
...
class Project(models.Model):
    ...
    reading_amount = models.IntegerField(_('amount of reading'), default=0, null=True, blank=True)

    document_type = models.CharField(_('Content types'), max_length=50, blank=True)
    ...
    requirements_file = models.CharField(
        ...
        blank=True, help_text=_(
            'A <a href="https://pip.pypa.io/en/latest/user_guide.html#requirements-files"> pip requirements file</a> needed to build your documentation. Path from the root of your project.'))
    ...
    conf_py_file = models.CharField(
        ...
        help_text=_(
            'Path from project root to <code>conf.py</code> file (ex. <code>docs/conf.py</code>). Leave blank if you want us to find it for you.'))
...
class ProjectContentType(models.Model):
    name = models.CharField(_('content type'), max_length=50)
