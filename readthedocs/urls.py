...
from readthedocs.core.views import HomepageView, SupportView, SearchTag, SearchContentTyp, SearchProjectName
...
basic_urls = [
    ...
    url(r'^searchtag/',SearchTag.as_view(),name='searchtag'),
    url(r'^searchcontenttyp/',SearchContentTyp.as_view(),name='searchcontenttyp'),
    url(r'^searchprojectname/',SearchProjectName.as_view(),name='searchprojectname'),
