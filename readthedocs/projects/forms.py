...
from readthedocs.projects.models import ProjectContentType
...
class UpdateProjectForm(ProjectTriggerBuildMixin, ProjectBasicsForm,
                        ProjectExtraForm):
    # document_type = forms.ModelChoiceField(label=_('Content types'), queryset=ProjectContentType.objects.all())
    document_type = forms.ChoiceField(label=_('Content types'), initial='none', required=False, )
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['document_type'].choices = utils.get_document_type()
